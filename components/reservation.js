...
import { apiAddReservation } from "../data/api";
        ...
        <div className="flex flex-col gap-y-10 justify-center">
            <form className="flex flex-row gap-x-6 text-lg font-normal " onSubmit={add}>
                ...
                <div className="flex flex-col gap-y-1">
                    ...
                    <input type="submit" value="Book"  className="bg-teal-300 hover:bg-teal-400 px-4 py-1 font-medium rounded-md shadow-sm self-center mt-8"/>
