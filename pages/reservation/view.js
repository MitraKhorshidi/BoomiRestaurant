...
import { apiSearchReservation } from "/data/apiClient";
    ...
    return (
      <Base>
        <div className="flex flex-col justify-center items-center gap-y-8 text-lg my-20">
          <p>
            Enter yor reservation and phone number to view your reservation
            detail.
          </p>
          <form onSubmit={search}>
            ...
            <input
              type="submit"
              value="Search"
              className="bg-teal-300 hover:bg-teal-400 px-4 py-1 font-medium rounded-md shadow-sm mt-5"
            />
          </form>
    ...
    <Base>
      <div className="flex flex-col justify-center items-center gap-y-5 mt-20">
        ...
        <p className="text-red-500 ">
          If you want to edit your reservation<br />{" "}
          first cancel it then book a new one.
        </p>
      </div>
    </Base>
  );
